...
# 4. shutil (內建模組)
#    - clean_directory: 自動清空 Markdown 與 Chunks 資料夾內的舊檔案。
# ==============================================================================
...
def clean_directory(dir_path: str):
    ...
    for item in os.listdir(dir_path):
        ...
        try:
            ...
            print(f"[markdown.py] [Warning] 無法刪除舊檔案 '{item_path}': {e}")
...
def convert_pdf_to_markdown(reports_dir: str = None, output_dir: str = None, enable_ocr: bool = False) -> bool:
    ...
    print(f"[markdown.py] 清理舊的 Markdown 與 Chunks 資料夾內容...")
    ...
    for pdf_path in pdf_files:
        ...
        try:
            ...
            # 順便執行 Chunking 並將結果輸出至 Chunks 資料夾
            try:
                from chunk import process_chunking
                process_chunking(output_path)
            except Exception as chunk_err:
                print(f"[markdown.py] [Warning] 執行 Chunking 失敗: {chunk_err}")
